...
echo'
<div class="nav flex px-10 my-2 sticky z-10 text-red-400 bg-white top-0">
    ...
    <ul class="flex space-x-4 grow items-center justify-center underline-offset-[21px]">
        <a href="index.php"><li class=" font-semibold hover:text-red-600 hover:underline active:underline ">Home</li>    </a>
        <a href="request.php"><li class=" font-semibold hover:text-red-600 hover:underline active:underline ">Requests</li></a>
        <a href="plzhelp.php "><li class=" font-semibold hover:text-red-600  hover:underline active:underline">Request For Blood</li></a>
        <a href="Aboutus.php"><li class=" font-semibold hover:text-red-600 hover:underline active:underline">About Us</li></a>
    </ul>
